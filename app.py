...
def get_stock_data(symbol):
    ...
    df = yf.download(symbol, period="1y")  # Last 1 year of data
    df['Date'] = df.index
...
def train_model(stock_data):
    ...
    # Ensure the data has enough rows to split
...
if symbol:
    ...
    if not stock_data.empty:
        ...
        if model:
            ...
            st.write("Model could not be trained due to insufficient data.")
